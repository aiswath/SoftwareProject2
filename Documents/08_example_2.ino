...
void loop() {
  ...
  if ((distance == 0.0) || (distance > _DIST_MAX)) {
      ...
      int brightness = 0; // LED ON
      
    if (distance <= 150.0) {
      // Map brightness from 100mm (0%) to 150mm (50%)
      brightness = map(distance, 100, 150, 0, 127); // 50% brightness at 150mm
    } else if (distance <= 200.0) {
      // Map brightness from 150mm (50%) to 200mm (100%)
      brightness = map(distance, 150, 200, 127, 255); // 100% brightness at 200mm
    } else if (distance <= 250.0) {
      // Map brightness from 200mm (100%) to 250mm (50%)
      brightness = map(distance, 200, 250, 255, 127); // 50% brightness at 250mm
    } else {
      // Map brightness from 250mm (50%) to 300mm (0%)
      brightness = map(distance, 250, 300, 127, 0); // 0% brightness at 300mm
    }
